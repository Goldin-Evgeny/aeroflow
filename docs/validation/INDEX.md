...
| [2026-08-17-1921-near-floor-timeout-loaded](runs/2026-08-17-1921-near-floor-timeout-loaded.md)           | 2026-08-17T19:20Z    | Near-floor factorial timeout calibration, 20-worker load         | 560 / 5,376     | `880b55c`+dirty | yes   | 5 tests passed; factorial test 1,560.206 s; workers cleaned; exit 1 from one transport timeout                                                     | AMBER | AMBER | N/A   | N/A                 | CONCERN  | RECORDED |
| [2026-08-17-2011-near-floor-timeout-yield](runs/2026-08-17-2011-near-floor-timeout-yield.md)             | 2026-08-17T20:10Z    | Near-floor factorial post-yield transport verification           | 560 / 5,376     | `be2ea0a`+dirty | yes   | 5 tests passed in 716.740 s; exit 0; summary byte-identical; zero transport errors                                                                 | GREEN | AMBER | N/A   | N/A                 | CONCERN  | RECORDED |
| [2026-08-18-0543-gpu-recovery-assertion-attempt](runs/2026-08-18-0543-gpu-recovery-assertion-attempt.md) | 2026-08-18T05:43Z    | Bounded Case C persistent-context recovery — assertion attempt   | 11,760          | `8466ae8`+dirty | yes   | Recovery mechanics reached rejection; command failed on overly narrow expected error text                                                          | AMBER | N/A   | N/A   | N/A                 | N/A      | RECORDED |
| [2026-08-18-0545-gpu-recovery-proof](runs/2026-08-18-0545-gpu-recovery-proof.md)                         | 2026-08-18T05:45Z    | Bounded Case C persistent-context recovery                       | 11,760          | `8466ae8`+dirty | yes   | Exact restore, forward progress, torn-newest fallback, and contamination rejection passed                                                          | GREEN | N/A   | N/A   | N/A                 | N/A      | RECORDED |
| [2026-08-18-0549-gpu-recovery-artifact-proof](runs/2026-08-18-0549-gpu-recovery-artifact-proof.md)       | 2026-08-18T05:49Z    | Bounded Case C recovery with durable artifact                    | 11,760          | `8466ae8`+dirty | yes   | Complete artifact: 3 checkpoints, 2 restores, 120 rows; disk refresh omission found                                                                | GREEN | AMBER | N/A   | N/A                 | N/A      | RECORDED |
| [2026-08-18-0553-gpu-recovery-final](runs/2026-08-18-0553-gpu-recovery-final.md)                         | 2026-08-18T05:53Z    | Final bounded Case C recovery and audit proof                    | 11,760          | `8466ae8`+dirty | yes   | Exact restores 1568/2688; torn 3976 fallback; 20,828,328 B state; complete artifact                                                                | GREEN | AMBER | N/A   | N/A                 | N/A      | RECORDED |
| [2026-08-18-0553-aij-tier-a-regression](runs/2026-08-18-0553-aij-tier-a-regression.md)                   | 2026-08-18T05:53:47Z | AIJ Tier-A small-scene/override regression                       | smoke overrides | `8466ae8`+dirty | yes   | 4 browser checks passed; scoring and suppression behavior unchanged                                                                                | GREEN | N/A   | N/A   | N/A                 | N/A      | RECORDED |
| [2026-08-18-0553-pressure-regression](runs/2026-08-18-0553-pressure-regression.md)                       | 2026-08-18T05:53:47Z | Pressure-outlet, kernel-emulation, and ABL regression            | 560 / smoke     | `8466ae8`+dirty | yes   | 3 files, 15 tests passed; existing ledger and acceptance assertions unchanged                                                                      | GREEN | GREEN | N/A   | N/A                 | N/A      | RECORDED |
| [2026-08-18-gpu-operation-liveness](runs/2026-08-18-gpu-operation-liveness.md)                           | 2026-08-18T07:28Z    | Bounded GPU operation liveness and automatic urban recovery      | 32³ / 11,760    | `7ffff0e`+dirty | yes   | 619 unit tests; 5 injected browser checks; fp32/fp16 bit identity; bounded median overhead −1.31%; checkpoint fallback/parity passed               | GREEN | N/A   | GREEN | N/A                 | RECORDED | RECORDED |
| [2026-08-18-outlet-feedback-discriminator](runs/2026-08-18-outlet-feedback-discriminator.md)             | 2026-08-18T10:02:54Z | Bounded near-floor zero-gradient vs pressure outlet discriminator | 560 × 4 arms    | `862a762`+dirty | yes   | outlet feedback observed: boundary-inlet separation at sample 25; zero-gradient diverged at 3346, pressure finite through 3600                    | GREEN | AMBER | N/A   | N/A                 | CONCERN  | RECORDED |
| [2026-08-18-validation-blockers-decidable-verification](runs/2026-08-18-validation-blockers-decidable-verification.md) | 2026-08-18T10:13:58Z | Final bounded verification and scope audit                        | unit / smoke    | `862a762`+dirty | yes   | 648 unit tests, 5 bounded browser tests, strict OpenSpec, lint, typecheck, and unchanged acceptance-band/operator audit passed                     | GREEN | N/A   | N/A   | N/A                 | N/A      | RECORDED |

| 2026-08-18T11:04:25.960Z | c63d503+dirty | CPU Float64 / GPU unavailable | pressure qualification | bounded | FAILED | [run](runs/2026-08-18-pressure-outlet-qualification.md) | v2 |
| [2026-08-18-pressure-outlet-qualification](runs/2026-08-18-pressure-outlet-qualification.md) | 2026-08-18T11:04:25.960Z | Bounded pressure-outlet qualification | 560 x 4 CPU arms; GPU unavailable | `c63d503`+dirty | yes | FAILED: mass drift 0.1218% legacy / 0.1977% spec exceeds 0.1%; GPU arms unavailable | AMBER | RED | N/A | N/A | RECORDED | FAILED |
| [2026-08-18-pressure-outlet-final-verification](runs/2026-08-18-pressure-outlet-final-verification.md) | 2026-08-18T11:22:38.348Z | Pressure-outlet change final bounded verification | unit / browser / GPU smoke | `2161477`+dirty | yes | 663 unit tests, 8 browser/GPU checks, strict OpenSpec, and protected-scope audit passed; qualification remains failed | GREEN | GREEN | N/A | N/A | RECORDED | RECORDED |
| [2026-08-18-d3q19-central-moment-qualification](runs/2026-08-18-d3q19-central-moment-qualification.md) | 2026-08-18T13:35:40Z | D3Q19 central-moment MRT v1 CPU qualification | 144 linear arms; 2 nonlinear arms | `c6e2c2d`+dirty | yes | FAILED: lambda-3.2 `Pi/Pi_hydro = 1.5050` exceeds `< 1.2`; GPU/LES not run | GREEN | GREEN | N/A | N/A | CONCERN | FAILED |
